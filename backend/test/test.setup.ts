...
const beforeEachFunction = beforeEach(async () => {
  ...
  await productObject.one('INSERT INTO users (_id, username, password, email) VALUES ' +
  ...
  await productObject.one('INSERT INTO attractions (_id, name, city, country, description, price, ratings, opening_hours, type_of_attraction) VALUES ' +
  ...
  await productObject.one('INSERT INTO flights (_id, departure_city, departure_country, arrival_city, arrival_country, departure_date, departure_time, flight_duration, ticket_price) VALUES ' +
